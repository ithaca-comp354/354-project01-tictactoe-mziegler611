...
public class SmartPlayer implements TicTacToePlayer{
    @Override
   ...
   for(int x=0; x<3; x++){
    ...
    if (curBoard.getSquares()[0][0] != ' ' && curBoard.getSquares()[0][0] != yourSymbol && curBoard.getSquares()[0][0] == curBoard.getSquares()[1][1] && curBoard.isSquareOpen(new Pair<>(2,2))){
        return new Pair<>(2,2);
    }
    if (curBoard.getSquares()[0][0] != ' ' && curBoard.getSquares()[0][0] != yourSymbol  && curBoard.getSquares()[2][2] == curBoard.getSquares()[0][0]  && curBoard.isSquareOpen(new Pair<>(1,1))){
        return new Pair<>(1,1);
    }
    if (curBoard.getSquares()[1][1] != ' ' && curBoard.getSquares()[1][1] != yourSymbol && curBoard.getSquares()[2][2] ==  curBoard.getSquares()[1][1] && curBoard.isSquareOpen(new Pair<>(0,0))){
        return new Pair<>(0,0);
    }

    if (curBoard.getSquares()[2][0] != ' ' && curBoard.getSquares()[2][0] != yourSymbol && curBoard.getSquares()[1][1] == curBoard.getSquares()[2][0]  && curBoard.isSquareOpen(new Pair<>(0,2))){
        return new Pair<>(0,2);
    }
    if (curBoard.getSquares()[2][0] != ' ' && curBoard.getSquares()[2][0] != yourSymbol  && curBoard.getSquares()[0][2] == curBoard.getSquares()[2][0] && curBoard.isSquareOpen(new Pair<>(1,1))){
        return new Pair<>(1,1);
    }
    if (curBoard.getSquares()[1][1] != ' ' && curBoard.getSquares()[1][1] != yourSymbol && curBoard.getSquares()[0][2] == curBoard.getSquares()[1][1] && curBoard.isSquareOpen(new Pair<>(2,0))){
        return new Pair<>(2,0);
    }
    
    if (curBoard.buildSquaresString().equals( "         ")){
